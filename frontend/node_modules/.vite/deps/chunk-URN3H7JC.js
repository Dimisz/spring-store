...
function useListChangeNotifiers() {
  ...
  const notifySelectionChanged = React26.useCallback((newSelectedItems) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newSelectedItems);
  }, [messageBus]);
  const notifyHighlightChanged = React26.useCallback((newHighlightedItem) => {
...
function useTextNavigation(callback) {
  const textCriteriaRef = React28.useRef({
    searchString: "",
    lastTime: null
  });
  return React28.useCallback((event) => {
...
function useList(params) {
  ...
  const handleHighlightChange = React29.useCallback((event, value, reason) => {
  ...
  const stateComparers = React29.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React29.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React29.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React29.useMemo(() => _extends({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
  ...
  const previousItems = React29.useRef([]);
  React29.useEffect(() => {
  ...
  const getItemState = React29.useCallback((item) => {
...
function useForcedRerendering() {
  const [, setState] = React30.useState({});
...
function useListItem(parameters) {
  ...
  const createHandleClick = React32.useCallback((other) => (event) => {
    var _other$onClick;
  ...
  const createHandlePointerOver = React32.useCallback((other) => (event) => {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React34.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React34.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  const subitemKeys = React34.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getItemDomElement = React34.useCallback((itemId) => {
...
function MenuProvider(props) {
  ...
  const listContextValue = React35.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex,
    registerHighlightChangeHandler,
  ...
  const compoundComponentContextValue = React35.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
...
var _excluded8 = ["actions", "children", "onItemsChange", "slotProps", "slots"];
...
var Menu = React36.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuItem(params) {
  ...
  const itemRef = React40.useRef(null);
  const itemMetadata = React40.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React40.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted,
...
var MenuItem = React41.forwardRef(function MenuItem2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
function useNumberInput(parameters) {
  ...
  const [value, setValue] = React43.useState(valueProp != null ? valueProp : defaultValueProp);
  const [dirtyValue, setDirtyValue] = React43.useState(value ? String(value) : void 0);
  React43.useEffect(() => {
...
var _excluded12 = ["className", "defaultValue", "disabled", "error", "id", "max", "min", "onBlur", "onInputChange", "onFocus", "onChange", "placeholder", "required", "readOnly", "shiftMultiplier", "step", "value", "slotProps", "slots"];
...
var NumberInput = React44.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime24.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime23.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime23.jsx)(IncrementButton, _extends({}, incrementButtonProps)), (0, import_jsx_runtime23.jsx)(Input3, _extends({}, inputProps))]
  }));
});
...
var OptionGroup = React45.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
...
function useOption(params) {
  ...
  const id = useId(idParam);
  const optionRef = React46.useRef(null);
  const selectOption = React46.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
var Option = React47.memo(React47.forwardRef(function Option2(props, forwardedRef) {
...
var Popup = React49.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const [exited, setExited] = React49.useState(true);
...
function useSelect(props) {
  ...
  const contextValue = React50.useMemo(() => _extends({}, listContextValue, compoundComponentContextValue), [listContextValue, compoundComponentContextValue]);
  let selectValue;
  if (props.multiple) {
...
var _excluded16 = ["areOptionsEqual", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "required", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "slotProps", "slots", "value"];
function defaultRenderValue(selectedOptions) {
  var _selectedOptions$labe;
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime30.jsx)(React52.Fragment, {
...
var Select = React52.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime31.jsxs)(React52.Fragment, {
...
var Snackbar = React54.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var Switch = React56.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React57.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var TablePagination = React58.forwardRef(function TablePagination2(props, forwardedRef) {
...
function useTabs(parameters) {
  ...
  const onSelected = React59.useCallback((event, newValue) => {
    setValue(newValue);
    onChange == null ? void 0 : onChange(event, newValue);
  }, [onChange, setValue]);
  const {
  ...
  const tabIdLookup = React59.useRef(() => void 0);
  const getTabPanelId = React59.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React59.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React59.useCallback((lookupFunction) => {
...
var TabsContext = React60.createContext(null);
if (true) {
  TabsContext.displayName = "TabsContext";
}
function useTabsContext() {
  const context = React60.useContext(TabsContext);
  if (context == null) {
...
var Tabs = React62.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React63.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
function useTabsList(parameters) {
  ...
  const contextValue = React65.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-URN3H7JC.js.map
