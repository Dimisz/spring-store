...
import "./chunk-QGRZ4VTJ.js";
import {
  Typography_default
} from "./chunk-MLY6H6F7.js";
import "./chunk-LOSEKWKP.js";
import "./chunk-ZMIFZTQX.js";
import "./chunk-IH4CLYI5.js";
import {
  useAutocomplete
} from "./chunk-URN3H7JC.js";
import "./chunk-Z3YX3KRO.js";
import "./chunk-HWEO2HYF.js";
import "./chunk-BCECB674.js";
import {
  require_react_dom
...
import "./chunk-QRPHLMDX.js";
import "./chunk-NPP4QTIA.js";
import "./chunk-7BOOO3CP.js";
import "./chunk-VY5MRW2K.js";
import {
  capitalize_default
} from "./chunk-IMBQV7VM.js";
import "./chunk-32U6FD6M.js";
import {
  alpha,
  clsx_default,
  composeClasses,
...
var _excluded2 = ["children", "className", "value"];
...
// node_modules/@mui/x-tree-view/node_modules/clsx/dist/clsx.m.js
function r(e) {
  var t, f, n = "";
...
var TreeViewContext = React48.createContext({
  registerNode: () => {
  },
  unregisterNode: () => {
  },
...
var DescendantContext = React49.createContext({});
if (true) {
...
function useDescendant(descendant) {
  const [, forceUpdate] = React49.useState();
  const {
    registerDescendant = noop,
    unregisterDescendant = noop,
    descendants = [],
    parentId = null
  } = React49.useContext(DescendantContext);
...
function DescendantProvider(props) {
  ...
  const [items, set] = React49.useState([]);
  const registerDescendant = React49.useCallback((_ref) => {
    let {
      element
  ...
  const unregisterDescendant = React49.useCallback((element) => {
  ...
  return (0, import_jsx_runtime24.jsx)(DescendantContext.Provider, {
    value,
    children
  });
}
...
function useTreeItem(nodeId) {
  const {
    ...
    selectRange,
    toggleExpansion
  } = React50.useContext(TreeViewContext);
...
var _excluded11 = ["classes", "className", "displayIcon", "expansionIcon", "icon", "label", "nodeId", "onClick", "onMouseDown"];
var TreeItemContent = React51.forwardRef(function TreeItemContent2(props, ref) {
  const {
    classes,
    className,
    displayIcon,
  ...
  return (
    ...
    (0, import_jsx_runtime26.jsxs)("div", _extends({}, other, {
...
true ? TreeItemContent.propTypes = {
   ...
   */
  displayIcon: import_prop_types12.default.node,
  /**
   * The icon to display next to the tree node's label. Either an expansion or collapse icon.
   */
  expansionIcon: import_prop_types12.default.node,
  /**
   ...
   * The id of the node.
   */
  nodeId: import_prop_types12.default.string.isRequired
} : void 0;
...
var _excluded12 = ["children", "className", "collapseIcon", "ContentComponent", "ContentProps", "endIcon", "expandIcon", "disabled", "icon", "id", "label", "nodeId", "onClick", "onMouseDown", "TransitionComponent", "TransitionProps"];
...
var TreeItem = React52.forwardRef(function TreeItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTreeItem"
  });
  ...
  const {
    ...
    unregisterNode,
    treeId
  } = React52.useContext(TreeViewContext);
  let id;
  if (idProp != null) {
    id = idProp;
  ...
  const [treeItemElement, setTreeItemElement] = React52.useState(null);
  const contentRef = React52.useRef(null);
  const handleRef = useForkRef(setTreeItemElement, ref);
  const descendant = React52.useMemo(() => ({
  ...
  return (0, import_jsx_runtime28.jsxs)(TreeItemRoot, _extends({
    ...
    onFocus: handleFocus,
    ref: handleRef,
    children: [(0, import_jsx_runtime27.jsx)(StyledTreeItemContent, _extends({
      as: ContentComponent,
      ref: contentRef,
      classes: {
      ...
      displayIcon,
      ownerState
    }, ContentProps)), children && (0, import_jsx_runtime27.jsx)(DescendantProvider, {
      id: nodeId,
      children: (0, import_jsx_runtime27.jsx)(TreeItemGroup, _extends({
...
true ? TreeItem.propTypes = {
   ...
   */
  collapseIcon: import_prop_types13.default.node,
  /**
   ...
   */
  ContentProps: import_prop_types13.default.object,
  /**
   ...
   */
  expandIcon: import_prop_types13.default.node,
  /**
   * The icon to display next to the tree node's label.
   */
...
var TreeItem3 = React53.forwardRef(function DeprecatedTreeItem(props, ref) {
  warn24();
  return (0, import_jsx_runtime29.jsx)(TreeItem, _extends({}, props, {
    ref
  }));
});
...
var _excluded13 = ["children", "className", "defaultCollapseIcon", "defaultEndIcon", "defaultExpanded", "defaultExpandIcon", "defaultParentIcon", "defaultSelected", "disabledItemsFocusable", "disableSelection", "expanded", "id", "multiSelect", "onBlur", "onFocus", "onKeyDown", "onNodeFocus", "onNodeSelect", "onNodeToggle", "selected"];
...
var TreeView = React54.forwardRef(function TreeView2(inProps, ref) {
  ...
  const isExpanded = React54.useCallback((nodeId) => Array.isArray(expanded) ? expanded.indexOf(nodeId) !== -1 : false, [expanded]);
  const isExpandable = React54.useCallback((nodeId) => nodeMap.current[nodeId] && nodeMap.current[nodeId].expandable, []);
  const isSelected = React54.useCallback((nodeId) => Array.isArray(selected) ? selected.indexOf(nodeId) !== -1 : selected === nodeId, [selected]);
  const isDisabled = React54.useCallback((nodeId) => {
    if (nodeId == null) {
      return false;
    }
  ...
  const unregisterNode = React54.useCallback((nodeId) => {
  ...
  const mapFirstChar = React54.useCallback((nodeId, firstChar) => {
    firstCharMap.current[nodeId] = firstChar;
  }, []);
  const unMapFirstChar = React54.useCallback((nodeId) => {
  ...
  return (0, import_jsx_runtime30.jsx)(TreeViewContext.Provider, {
    ...
    children: (0, import_jsx_runtime30.jsx)(DescendantProvider, {
      children: (0, import_jsx_runtime30.jsx)(TreeViewRoot, _extends({
        role: "tree",
        id: treeId,
...
var TreeView3 = React55.forwardRef(function DeprecatedTreeView(props, ref) {
  warn25();
  return (0, import_jsx_runtime31.jsx)(TreeView, _extends({}, props, {
    ref
  }));
});
...
var _excluded14 = ["children", "className", "component", "columns", "spacing", "defaultColumns", "defaultHeight", "defaultSpacing"];
...
var Masonry = React56.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React56.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React56.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React56.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = _extends({}, props, {
    spacing,
    columns,
    maxColumnHeight,
...
true ? Masonry.propTypes = {
   ...
   * @default 4
   */
  columns: import_prop_types17.default.oneOfType([import_prop_types17.default.arrayOf(import_prop_types17.default.oneOfType([import_prop_types17.default.number, import_prop_types17.default.string])), import_prop_types17.default.number, import_prop_types17.default.object, import_prop_types17.default.string]),
  /**
   ...
   */
  defaultColumns: import_prop_types17.default.number,
  /**
   * The default height of the component in px. This is provided for server-side rendering.
   */
  defaultHeight: import_prop_types17.default.number,
  /**
   * The default spacing of the component. Like `spacing`, it is a factor of the theme's spacing. This is provided for server-side rendering.
   */
  defaultSpacing: import_prop_types17.default.number,
  /**
